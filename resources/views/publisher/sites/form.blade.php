...
<label>Default revenue share %<input class="hm-input" type="number" min="0" max="100" step="0.01" name="default_revenue_share_percent" value="{{ old('default_revenue_share_percent', $site->default_revenue_share_percent ?? 70) }}" required></label>
