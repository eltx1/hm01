...
@section('navigation')<a href="{{ route('dashboard') }}">Overview</a><a href="{{ route('publisher.sites.index') }}">Websites</a><a class="active" href="{{ route('publisher.contracts.index') }}">Contracts</a>@endsection
