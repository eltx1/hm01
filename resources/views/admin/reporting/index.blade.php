...
<form method="get" class="form-grid"><label>From<input type="date" name="from" value="{{ $summary['from']->toDateString() }}"></label><label>To<input type="date" name="to" value="{{ $summary['to']->toDateString() }}"></label><div class="form-readonly"><span>Reporting currency</span><strong>US Dollar (USD)</strong><small>Horus requests GAM revenue from Google in USD.</small></div><button class="hm-button-primary" type="submit">Apply dates</button></form>
