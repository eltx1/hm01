...
export default defineConfig({
    ...
    testMatch: ['traffic-gate.playwright.spec.js', 'traffic-gate-loader.playwright.spec.js', 'rewarded-reading.playwright.spec.js', 'responsive-bundle.playwright.spec.js'],
