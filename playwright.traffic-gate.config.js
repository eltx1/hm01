...
export default defineConfig({
    ...
    testMatch: ['traffic-gate.playwright.spec.js', 'traffic-gate-loader.playwright.spec.js', 'rewarded-reading.playwright.spec.js', 'responsive-bundle.playwright.spec.js', 'quick-input-mode.playwright.spec.js', 'site-gam-reporting.playwright.spec.js'],
