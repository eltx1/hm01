...
class Task29AdminViewDiagnosticTest extends TestCase
{
    ...
    public function test_admin_application_view_exposes_underlying_exception(): void
    {
        $this->seedIdentity();
        Notification::fake();
        ...
        Config::set('publisher-applications.legal_documents', [
            'TERMS_OF_SERVICE' => ['label' => 'Terms of Service', 'version' => '2026-08', 'url' => 'https://horusmedia.net/legal/terms?v=2026-08', 'required' => true],
            'PRIVACY_POLICY' => ['label' => 'Privacy Policy', 'version' => '2026-08', 'url' => 'https://horusmedia.net/legal/privacy?v=2026-08', 'required' => true],
        ]);
