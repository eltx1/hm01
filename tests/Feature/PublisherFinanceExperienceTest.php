...
class PublisherFinanceExperienceTest extends TestCase
{
    ...
    public function test_publisher_finance_pages_separate_estimated_finalized_and_currencies(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('Canonical reporting · USD')
            ->assertSee('USD 70.00')
    ...
    public function test_publisher_dashboard_is_canonical_usd_and_does_not_mix_legacy_currencies(): void
    {
        [$admin, $publisher, $publisherAdmin, , $site] = $this->context();
        ...
        $page->assertOk()
            ...
            ->assertDontSee('Publisher earnings · EUR');
        ...
        $this->assertSame(7000, $dashboard['finalized_earnings_minor']);
    }
