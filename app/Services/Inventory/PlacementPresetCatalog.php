...
final class PlacementPresetCatalog
{
    ...
    public function choices(): array
    {
        return [
            ...
            'in_article_display' => ['label' => 'In-Article Display', 'summary' => 'Responsive display surface intended for a position inside article content.', 'badge' => 'Content', 'group' => 'Display', 'format' => 'display_in_article', 'type' => PlacementType::Display->value, 'mount' => 'in-page', 'quick' => true],
