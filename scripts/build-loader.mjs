...
const source = applyShadowClickGuardTransform(applyTrafficGateTransform(baseSource));
...
console.log(`Built ${outputPath.pathname} with Client Traffic Gate and shadow-aware Click Guard runtime`);
