...
class IdentityAccessSeeder extends Seeder
{
    public const PERMISSIONS = [
        ...
        'publisher_applications.view' => ['View public Publisher applications', 'publishers'],
        'publisher_applications.review' => ['Review public Publisher applications', 'publishers'],
        ...
        'traffic_gate.manage' => ['Manage Client Traffic Gate', 'operations'],
        'traffic_gate.emergency_disable' => ['Emergency disable Client Traffic Gate', 'operations'],
    ...
    private function permissionsFor(RoleName $role, Collection $permissions): array
    {
        ...
        $names = match ($role) {
            RoleName::OperationsAdmin => array_merge(['dashboard.admin.view', 'organizations.view', 'organizations.manage', 'publishers.view', 'publishers.manage', 'publisher_applications.view', 'publisher_applications.review', 'advertisers.view', 'advertisers.manage', 'users.view', 'users.manage', 'users.invite', 'roles.view', 'audit.view', 'internal_notes.view', 'branding.manage', 'sites.view', 'sites.manage', 'sites.review', 'sites.serving.manage', 'gam.connections.view', 'gam.connections.manage', 'gam.connections.test', 'gam.connections.assign', 'contracts.view', 'contracts.manage', 'publisher_payments.manage', 'finance.publisher.view', 'finance.payment_profiles.verify', 'finance.internal_margin.view', 'operations.view', 'operations.manage', 'traffic_gate.manage', 'traffic_gate.emergency_disable', 'support.manage', 'support.admin.view', 'support.admin.reply', 'support.admin.assign', 'support.admin.manage', 'support.internal_notes.view'], $inventory, $demandAdmin, $campaignAdmin, $reportingAdmin, $financeOperations, $adsTxtAdmin, $sellersAdmin),
            RoleName::AdOpsAdmin => array_merge(['dashboard.admin.view', 'publishers.view', 'publisher_applications.view', 'publisher_applications.review', 'advertisers.view', 'users.view', 'audit.view', 'sites.view', 'sites.manage', 'sites.review', 'sites.serving.manage', 'gam.connections.view', 'gam.connections.manage', 'gam.connections.test', 'gam.connections.assign', 'traffic_gate.manage'], $inventory, $demandAdmin, $campaignAdmin, ['reporting.admin.view', 'reporting.sources.manage', 'reporting.import', 'operations.view'], $adsTxtAdmin, $sellersAdmin),
