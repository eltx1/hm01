...
class IdentityAccessSeeder extends Seeder
{
    ...
    private function permissionsFor(RoleName $role, Collection $permissions): array
    {
        ...
        $names = match ($role) {
            RoleName::OperationsAdmin => array_merge(['dashboard.admin.view', 'organizations.view', 'organizations.manage', 'publishers.view', 'publishers.manage', 'publisher_applications.view', 'publisher_applications.review', 'advertisers.view', 'advertisers.manage', 'users.view', 'users.manage', 'users.invite', 'roles.view', 'audit.view', 'internal_notes.view', 'branding.manage', 'sites.view', 'sites.manage', 'sites.review', 'sites.serving.manage', 'gam.connections.view', 'gam.connections.manage', 'gam.connections.test', 'gam.connections.assign', 'contracts.view', 'contracts.manage', 'publisher_payments.manage', 'finance.publisher.view', 'finance.payment_profiles.verify', 'finance.internal_margin.view', 'operations.view', 'operations.manage', 'support.manage', 'support.admin.view', 'support.admin.reply', 'support.admin.assign', 'support.admin.manage', 'support.internal_notes.view'], $inventory, $demandAdmin, $campaignAdmin, $reportingAdmin, $financeOperations, $adsTxtAdmin, $sellersAdmin),
            RoleName::AdOpsAdmin => array_merge(['dashboard.admin.view', 'publishers.view', 'publisher_applications.view', 'publisher_applications.review', 'advertisers.view', 'users.view', 'audit.view', 'sites.view', 'sites.manage', 'sites.review', 'sites.serving.manage', 'gam.connections.view', 'gam.connections.manage', 'gam.connections.test', 'gam.connections.assign'], $inventory, $demandAdmin, $campaignAdmin, ['reporting.admin.view', 'reporting.sources.manage', 'reporting.import', 'operations.view'], $adsTxtAdmin, $sellersAdmin),
